# Generated by Django 4.1.2 on 2023-03-28 14:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(blank=True, null=True)),
                ('updated_at', models.DateTimeField(blank=True, null=True)),
                ('client_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='main.clients')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='main.authuser')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(blank=True, null=True)),
                ('deleted_at', models.DateTimeField(blank=True, null=True)),
                ('brand_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='main.brand')),
                ('company_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='main.company')),
                ('generic_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='main.generic')),
            ],
            options={
                'db_table': 'item',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(blank=True, null=True)),
                ('client_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='main.clients')),
                ('discount_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='main.discounts')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='main.authuser')),
            ],
            options={
                'db_table': 'sales',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(blank=True, null=True)),
                ('sales_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='main.sales')),
            ],
            options={
                'db_table': 'payment',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(blank=True, null=True)),
                ('inpatient_sales_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='main.inpatientsales')),
                ('item_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='main.item')),
                ('sales_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='main.sales')),
            ],
            options={
                'db_table': 'out_items',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(blank=True, null=True)),
                ('item_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='main.item')),
                ('location_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='main.location')),
            ],
            options={
