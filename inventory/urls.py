...
urlpatterns = [
    ...
    path('update_stock_location',
         views.update_stock_location, name='update-stock-location'),
    path('update_stock_damage',
         views.update_stock_damage, name='update-stock-damage'),
